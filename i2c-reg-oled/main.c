...
void i2c_init() {
    ...
    I2C->TIMINGR = (unsigned)0x00B01A4B;
    
    // Enable I2C
    I2C->CR1 |= 1;
}
void i2c_start(unsigned n_bytes) {
    // Autoend, set the number of bytes to transfer, and the address
    I2C->CR2 = 1<<25 | n_bytes<<16 | I2C_ADDR << 1;
}
void i2c_write(unsigned char byte) {
    ...
    // Fill TX and send it over (start!)
